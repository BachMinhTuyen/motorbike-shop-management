...
<div class="row">
    ...
    <div class="col-9">
        <div class="m-3">
            <div class="mb-3">
                <a href="{{route('user.addUser')}}" class="btn btn-primary">Thêm nhân viên</a>
            </div>
            <div class="mb-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-evenly">
                                <a href="/user/profile/{{$item->username}}" type="button" class="btn btn-primary detailLink">Chi Tiết</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('user.updateProfile')}}" method="POST">
                    @csrf
                    <input type="text" name="id" id="userIdInput" hidden>
                    <div class="mb-3">
                        <label for="userNameInput" class="form-label">Tên Khách Hàng</label>
                        <input type="text" class="form-control" id="userNameInput" name="fullName">
                    </div>
                    <div class="mb-3">
